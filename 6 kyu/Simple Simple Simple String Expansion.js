...
function stringExpansion(s) {
    ...
    for(let char of  s) {
        if(char >= "0" && char <= "9") {
            ...
            const repeat = number === null ? 1 : number;
...
stringExpansion('3D2a5d2f') // 'DDDaadddddf
stringExpansion('0d0a0v0t0y') //
stringExpansion('3d332f2a') // 'dddffa
stringExpansion('abcde') // 'abcd
stringExpansion('a2bcde') // 'abbccdde
